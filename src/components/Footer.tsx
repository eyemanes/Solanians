...
export function Footer() {
  ...
  const footerLinks = [
    {
      title: "Product",
      links: ["Features", "Roadmap", "Changelog", "API"],
    },
    {
      title: "Community",
    ...
    {
      title: "Resources",
      links: ["Documentation", "Tutorials", "Examples", "FAQ"],
    },
    {
      title: "Company",
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="py-16 border-b border-border/30">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="body-base text-gray-400 mb-8">
              Get the latest updates on Solana development and community initiatives
            </p>
            ...
            {isSubscribed && (
              <p className="text-green-400 text-sm mt-4 animate-fade-in">
                Welcome to the Solanian community! Check your email for confirmation.
              </p>
            )}
          </div>
        </div>
        ...
        <div className="py-8 border-t border-border/30">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-col sm:flex-row items-center gap-4 text-sm text-gray-400">
              <p>© 2024 Solanians. All rights reserved.</p>
